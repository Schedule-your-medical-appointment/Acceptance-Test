...
Scenario 1: El usuario escoge un dìa vàlido del calendario.
...
Scenario 2: El usuario escoge un dìa no valido
...
Scenario 3: El usuario no escoge ningùn dìa en el calendario
